...
plt.xticks(np.arange(max(Japan_date_hour_count_pandas['date'])))
plt.yticks(np.arange(max(Japan_date_hour_count_pandas['hour'])))
...
plt.xticks(np.arange(max(UK_date_hour_count_pandas['date'])))
plt.yticks(np.arange(max(Uk_date_hour_count_pandas['hour'])))
plt.xlabel("Date", fontsize=13)
plt.ylabel("Hour", fontsize=13)
...
plt.xticks(np.arange(max(US_date_hour_count_pandas['date'])))
plt.yticks(np.arange(max(US_date_hour_count_pandas['hour'])))
plt.xlabel("Date", fontsize=13)
plt.ylabel("Hour", fontsize=13)
plt.title("Heatmaps for Top University in UK", fontsize=18)
